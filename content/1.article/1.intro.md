...
The first step (for non-developers) is to [create GitHub-account](https://github.com/join).[^1]
...
[^1]: Not necessary on this time in the tutorial, but the best time to do it. No need to do something else yet. So please return to the tutorial;)
